            ...
            <section class="product-details padding-bottom mt--240 mt-lg--440">
                <div class="container">
                    ...
                    <div class="row mt-40-60-80">
                        ...
                        $todaydatez = $date->format('Y-m-d');
                        $endingdatez = $value4['biddingenddate'];

                        $diff = abs(strtotime($endingdatez) - strtotime($todaydatez));
                        ...
                        $todaytime = date("h:i");
                        $endingtimez = $value4['biddingendtime'];
                        ?>
                        <div class="col-lg-4">
                            <div class="product-sidebar-area">
                                <div class="product-single-sidebar mb-3">
                                    <h6 class="title">This Auction Ends in:</h6>
                                    <p style="font-size: 25px;color: red;"><b>  <?php echo $days; ?>  Days</b> </p>
