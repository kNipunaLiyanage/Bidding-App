...
<html lang="en">
    ...
    if (!(isset($institutename))) {
        ...
        <body data-sidebar="dark">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM orderdetails where statusorder='Pending' ORDER BY oderid DESC";
            ...
            <!--                                                            <td> <button class="btn btn-info waves-effect waves-light" onclick="ViewPendingOrderdetails(<?php echo $value4['oderid']; ?>)">View Order Details</button></td>
                                                            -->
                                                            <td> <button class="btn btn-success waves-effect waves-light" onclick="accepted()">Accept Order</button></td>
