        ...
        <body data-sidebar="dark">
                                ...
                                <div class="col-sm-6">
                                    <div class="page-title-box">
                                        ...
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">SBIDU</a></li>
                                            ...
                                            <form class="login-form" method="POST" action="../phpfiles/Admin_add_new_category.php" enctype="multipart/form-data"  id="form">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <button type="button" onclick="loadz()" class="form-control btn btn-success">Save Data</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
            ...
            <script>
                $("#form").on('submit', (function(e) {
                    ...
                    e.preventDefault();
                    $.ajax({
                        url: "../phpfiles/Admin_add_new_category.php",
                        type: "POST",
                        ...
                        success: function(data)
                        {
                            ...
                            else
                            {
                                ...
                                window.location = "AdminAddNewCategory.php";
                            }
                        },
                        error: function(e)
                        {
