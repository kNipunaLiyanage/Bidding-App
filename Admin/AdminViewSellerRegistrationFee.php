...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>View Seller Registration Fees | SBIDU</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">Seller Registration Fees</h4>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-middle table-centered table-vertical table-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM userdetails where usertype='Seller' and userstatus='Active'";
                                                        ...
                                                        foreach ($query4 as $value4) {
                                                            ...
                                                            foreach ($query45 as $value45) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>Payment Date<?php echo $value45['dateregistered']; ?></td>
                                                                    <td>Due Date<?php echo $value45['datetorenew']; ?></td>
                                                                    <td>
                                                                        <a href="../phpfiles/<?php echo $value45['payementslip']; ?>" target="_blank" class="btn btn-warning waves-effect waves-light">View Payment Slip</a>
