...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view Ongoing Bids Single View</title>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-title-desc">here are the item details that clicked and the item expire date is<p style="font-size: 20px;color: red;"><?php echo $expiredate; ?></p>
                                                </p>
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <p class="card-title-desc">here are the Bidders that bid for<p style="font-size: 20px;color: red;"><?php echo $value4['proname']; ?></p>
                                                </p>
                                                ...
                                                <button style="width: 100%;" class="btn btn-success btn-lg waves-effect waves-light" onclick="EndBid(<?php echo $value4['id']; ?>)">End BID</button>
                                            </div>
                                        </div>
                                    </div>
