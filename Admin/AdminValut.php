                        ...
                        <div class="container-fluid">
                                ...
                                <div class="col-sm-6">
                                    <div class="page-title-box">
                                        ...
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Sams & Sams</a></li>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">Your Transactions</h4>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($query45 as $value45) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value45['itemname']; ?> </td>
                                                            <td><?php echo $value45['itemselledcost']; ?> </td>
                                                            <td><?php echo $value45['yourcost']; ?> </td>
                                                            <td><?php echo $value45['deliverycost']; ?> </td>
                                                            <td><button class="btn btn-sm btn-info">View Order details</button></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                    ?>
                                            ...
                                            <h2>Your Total Sales Income <span class="badge bg-light">LKR <?php echo $totalsell; ?> /=</span></h2>
                                            <h2>Your Total delivery Cost <span class="badge bg-light">LKR <?php echo $totdeliverysell; ?> /=</span></h2>
                                        </div>
                                    </div>
                                </div>
