...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Admin - Sams and Sams</title>
...
<!--                                        <img src="../assets/images/logo/log33.png" alt="" height="60" class="auth-logo-dark">
                                        <img src="../assets/images/logo/log33.png" alt="" height="60" class="auth-logo-light">-->
                                    </a>
                                </h3>
        ...
        <script type="text/javascript" src="../ScriptFiles/Admin_login_controller.js"></script>
    </body>
