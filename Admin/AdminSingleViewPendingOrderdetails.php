...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view pending order details </title>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                foreach ($query45 as $value45) {
                                                    ...
                                                    <button style="width: 100%;" class="btn btn-success btn-lg waves-effect waves-light" onclick="ConfirmOrder(<?php echo $value45['oderid']; ?>)">Confirm Order</button>
                                                </div>
                                            </div>
                                        </div>
