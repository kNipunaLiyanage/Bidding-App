...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>View Buyers | Sams And Sams</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-4">Removed Buyer Details</h4>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table align-middle table-centered table-vertical table-nowrap">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM userdetails where usertype='Buyer' and userstatus='Delete'";
