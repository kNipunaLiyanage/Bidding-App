...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view Ongoing Bids</title>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title">Ongoing Listings</h4>
                                            <p class="card-title-desc"> Here are the seller Ongoing Listings.
                                            </p>
...
<!--                                                            <th>Remaining Time</th>-->
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM sellerpostitem where status='Accept' ORDER BY posteddate DESC";
                                                        $query4 = $conn->query($sqlzy34);
                                                        $increz = 0;
                                                        foreach ($query4 as $value4) {

                                                            $daterem = $value4['biddingendtime'];
...
<!--                                                                <td id="dd<?php echo $value4['id']; ?>"><?php echo $elapsed ?></td>-->
                                                                <td><?php echo $value4['biddingleastprice']; ?></td>
                                                                <td><?php echo $value4['contactno']; ?></td>
                                                                <td> <button class="btn btn-info waves-effect waves-light" onclick="ViewSingleBid(<?php echo $value4['id']; ?>)">View Details</button></td>

                                                                <td> <button class="btn btn-success waves-effect waves-light" onclick="EndBid(<?php echo $value4['id']; ?>)">End BID</button></td>
