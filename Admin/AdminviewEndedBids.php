...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view ENDED Bids</title>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title">Ended Bids</h4>
                                            <p class="card-title-desc"> Here are the Ended Bids.
                                            </p>
                                            <div class="table-responsive">
                                                <table class="table mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM sellerpostitem where status='END' ORDER BY posteddate DESC";
                                                        ...
                                                        foreach ($query4 as $value4) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td> <button class="btn btn-info waves-effect waves-light" onclick="ViewSingleBidEnded(<?php echo $value4['id']; ?>)">View Details</button></td>
