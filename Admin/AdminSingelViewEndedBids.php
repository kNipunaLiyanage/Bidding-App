...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view ENDED Bids Single View</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <?php
                                        $sqlz = "SELECT * FROM itemhasabid where itemid='$itemid' and status='Active' ORDER BY bidamount DESC LIMIT 1";
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            if ($row = $result->fetch_assoc()) {
                                                ...
                                                <p class="card-title-desc"><p style="font-size: 20px;color: red;"><?php echo $row['buyername']; ?></p>is the highest bidder for LKR<p class="card-title-desc"><p style="font-size: 20px;color: red;"><?php echo $row['bidamount']; ?> /=</p>
                                                </p>
                                                <?php
                                            }
                                        }
