...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin Removed Details</title>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">Here you can view all Removed user details
                                            </p>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM userdetails where userstatus='Delete'";
                                                    ...
                                                    foreach ($query4 as $value4) {
                                                        ...
                                                        foreach ($query45 as $value45) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button" onclick="AcceptUser(<?php echo $value4['id']; ?>)" class="btn btn-success waves-effect waves-light">Active</button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
                                        ...
                                        function AcceptUser(vv) {
                                            ...
                                            function(data, status) {
                                                ...
                                                if (data == "ok") {
                                                    ...
                                                    window.location = "AdminViewAllActiveUsers.php";
