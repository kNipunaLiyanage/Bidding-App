                ...
                <div class="container">
                    <div class="row justify-content-center">
                                ...
                                <ul class="dashboard-menu">
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        if ($row = $result->fetch_assoc()) {
                                            ?>
                                            <li>
                                                <a href="buyerNotification.php" class="active"><i class="flaticon-alarm"></i>My Alerts(<?php echo $row["total"]; ?>)</a>
                                            </li>
                                            <?php
                                        }
                                    }
                        ...
                        <div class="col-lg-8">
                            ...
                            $sqlzy34 = "SELECT * FROM usergotnotificationfromseller where buyeremail='$emaillog' and stats='notread'";
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <label for="check1">
                                                    ...
                                                    <p><?php echo $value4['notification']; ?>  <?php echo $value4['expiredatez']; ?></p>

                                                    <table>
                                                        <tr>
                                                            <td> <button class="btn btn-sm btn-info" onclick="ViewSingleProducttoConfirm(<?php echo $value4['itemid']; ?>)">View Item</button></td>
