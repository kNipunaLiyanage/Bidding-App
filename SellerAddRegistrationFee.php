                    ...
                    <div class="col-sm-10 col-md-7 col-lg-4">
                        <div class="dashboard-widget mb-30 mb-lg-0">
                            ...
                            <ul class="dashboard-menu">
                                ...
                                ?>
                                <li>
                                    <a href="SellerAddRegistrationFee.php" class="active"><i class="flaticon-best-seller"></i>Make Registration Fee</a>
                                </li>
                    ...
                    <div class="col-lg-8">
                        <div class="dashboard-widget mb-40">
                            <div class="dashboard-title mb-30">
                                <h5 class="title">Make a Registration Fee </h5>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        else
                        {
                            ...
                            window.location = "SellerAddRegistrationFee.php";
                        }
                    },
                    error: function(e)
                    {
