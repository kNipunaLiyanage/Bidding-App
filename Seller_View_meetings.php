...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col-sm-10 col-md-7 col-lg-4">
                            <div class="dashboard-widget mb-30 mb-lg-0">
                                ...
                                <ul class="dashboard-menu">
                                    ...
                                    <li>
                                        <a href="Seller_View_meetings.php" class="active"><i class="flaticon-auction"></i>Meeting Request On Items</a>
                                    </li>
                                    <?php
                                        ...
                                        <div class="tab-pane show active fade" id="current">
                                            <table class="purchasing-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM buyerarrangemeetings where selleremail='$emaillog'";
                                                    $query4 = $conn->query($sqlzy34);

                                                    foreach ($query4 as $value4) {
                                                        ?>
                                                        <tr>
                                                            <td data-purchase="Product"><?php echo $value4['pronamez']; ?></td>
                                                            <td data-purchase="Meeting ID"><?php echo $value4['idgenarated']; ?></td>
                                                            <td data-purchase="Date"><?php echo $value4['datez']; ?></td>
                                                            <td data-purchase="Message"><?php echo $value4['message']; ?></td>
                                                            <td data-purchase="Buyer Name"><?php echo $value4['buyername']; ?></td>
                                                            <?php
                                                            $ite = $value4['satus'];
                                                            if ($ite == "Pending") {
                                                                ?>
                                                                <td data-purchase="status"><i class="flaticon-check text-warning"></i>Pending</td>
                                                                <td><button onclick="AcceptMeeting(<?php echo $value4['id']; ?>)" class="btn btn-success">Accept</button></td>
                                                                <td></td>
                                                                <td><button onclick="RemovetMeeting(<?php echo $value4['id']; ?>)" class="btn btn-danger">Reject</button></td>
                                                                <?php
                                                            } else if ($ite == "Accept") {
                                                                ?>
                                                                <td data-purchase="status"><i class="flaticon-check text-success"></i>Accepted</td>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <td data-purchase="status"><i class="flaticon-check text-danger"></i>Canceled</td>
                                                                <?php
                                                            }
                                                            ?>
        ...
        <script type="text/javascript" src="ScriptFiles/Seller_manege_Meetings_controller.js"></script>
    </body>
