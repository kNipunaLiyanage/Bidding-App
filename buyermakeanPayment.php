    ...
    <body>
                        ...
                        <div class="col-sm-10 col-md-7 col-lg-4">
                            <div class="dashboard-widget mb-30 mb-lg-0">
                                ...
                                <ul class="dashboard-menu">
                                    ...
                                    <li>
                                        <a href="buyermakeanPayment.php"  class="active"><i class="flaticon-money"></i>Add Deposit Amount</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-lg-8">
                            <div class="dashboard-widget mb-40">
                                ...
                                <div class="row justify-content-center mb-30-none">
                                    <form class="login-form" method="POST" action="phpfiles/buyer_deposit_payment.php" enctype="multipart/form-data"  id="form">
                                        <label for="login-email">Payment amount</label>
                                        <div class="form-group mb-30">
                                            <input type="text" id="amountpaying" name="amountpaying"placeholder="Payment Amount">
                                        </div>
                                        ...
                                        <div class="form-group mb-0">
                                            <button type="submit" onclick="" class="custom-button">Make Deposit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                        ...
                                        <div class="tab-pane show active fade" id="current">
                                            <table class="purchasing-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM buyerpaymentforvalult where buyeremail='$emaillog' ORDER BY id DESC";
                                                    $query4 = $conn->query($sqlzy34);

                                                    foreach ($query4 as $value4) {
                                                        $paymentstatuseka = $value4['statuspayment'];
                                                        ?>
                                                        <tr>
                                                            <td>LKR <?php echo $value4['amountz']; ?></td>
                                                            <td><?php echo $value4['datez']; ?></td>
                                                            <td><?php echo $value4['timez']; ?></td>
                                                            <?php
                                                            if ($paymentstatuseka == "Pending") {
                                                                ?>
                                                                <td> <i class="flaticon-check text-muted"></i>&nbsp;&nbsp;&nbsp;&nbsp;Pending</td>
                                                                <?php
                                                            } else if ($paymentstatuseka == "Accept") {
                                                                ?>
                                                                <td> <i class="flaticon-check text-success"></i>&nbsp;&nbsp;&nbsp;&nbsp;Complete</td>
                                                            </tr>
                                                            <?php
                                                        } else {
                                                            ?>
                                                        <td> <i class="flaticon-check text-danger"></i>&nbsp;&nbsp;&nbsp;&nbsp;Failed</td>
                                        ...
                                        <div class="tab-pane show fade" id="pending">
                                            <table class="purchasing-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy345 = "SELECT * FROM buyerpaymentforvalult where buyeremail='$emaillog' and statuspayment='Pending' ORDER BY id DESC";
                                                    $query45 = $conn->query($sqlzy345);

                                                    foreach ($query45 as $value45) {
                                                        $paymentstatuseka = $value45['statuspayment'];
                                                        ?>
                                                        <tr>
                                                            <td>LKR <?php echo $value45['amountz']; ?></td>
        ...
        <script>
            $("#form").on('submit', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "phpfiles/buyer_deposit_payment.php",
                    type: "POST",
