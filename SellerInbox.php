...
<html lang="en">
    ...
    <head>
        ...
        <title>Sbidu - Seller Inbox</title>
    ...
    <body>
                ...
                <div class="row justify-content-center">
                            ...
                            <ul class="dashboard-menu">
                                    ...
                                    if ($result4->num_rows > 0) {
                                        ...
                                        if ($row4 = $result4->fetch_assoc()) {
                                            ?>
                                            <li>
                                                <a href="SellerInbox.php"  class="active"><i class="flaticon-alarm"></i>My Inbox(<?php echo $row4["total"]; ?>)</a>
                                            </li>
                                            <?php
                                        }
                                    }
                    ...
                    <div class="col-lg-8">
                        <div class="dash-bid-item dashboard-widget mb-30">
                            <div class="header">
                                <h4 class="title mw-100">My Messages</h4>
                            </div>
                        ...
                        $sqlzy34 = "SELECT * FROM messages_buyer_to_seller where selleremail='$emaillog' ORDER BY id DESC";
                                ...
                                <div class="alert-widget tab-pane show fade active" id="alerts">
                                    <ul>
                                        <li>
                                            ...
                                            <label for="check1">
                                                <h6 class="title"><i class="flaticon-check text-warning"></i>&nbsp;&nbsp;You got new Message from <?php echo $value4['buyername']; ?> on <?php echo $value4['datez']; ?> at <?php echo $value4['timez']; ?> </h6>
                                                <p><?php echo $value4['messagez']; ?></p>

                                                <table>
                                                    <tr>
                                                        <td> <button class="btn btn-sm btn-success" onclick="MessageBuyer(<?php echo $value4['id']; ?>)">Reply</button></td>
        ...
        ?>
                    ...
                    <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
                    <script type="text/javascript" src="ScriptFiles/buyerinboxcontroller.js"></script>
                    </body>
