...
<html lang="en">
    ...
    <head>
        ...
        <title>Sbidu - Buyer My Meeting</title>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-10 col-md-7 col-lg-4">
                            <div class="dashboard-widget mb-30 mb-lg-0">
                                ...
                                <ul class="dashboard-menu">
                                    ...
                                    ?>
                                    <li>
                                        <a href="Buyer_My_meetings.php" class="active"><i class="flaticon-alarm"></i>Meeting Details</a>
                                    </li>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="dashboard-widget">
                                <h5 class="title mb-10">Your Meetings</h5>
                                        ...
                                        <div class="tab-pane show active fade" id="current">
                                            <table class="purchasing-table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM buyerarrangemeetings where buyeremail='$emaillog'";
                                                    ...
                                                    foreach ($query4 as $value4) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            if ($ite == "Pending") {
                                                                ...
                                                                ?>
                                                                <td data-purchase="status"><i class="flaticon-check text-warning"></i>Accepted</td>
                                                                <?php
                                                            } else {
                                                                ?>
