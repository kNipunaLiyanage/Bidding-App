                        ...
                        <div class="col-sm-10 col-md-7 col-lg-4">
                            <div class="dashboard-widget mb-30 mb-lg-0 sticky-menu">
                                <div class="user">
                                    ...
                                    <li>
                                        <a href="Sellermyitems.php"  class="active"><i class="flaticon-auction"></i>My Items on Auction</a>
                                    </li>
                                    <li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="upcoming">
                                    <div class="row mb-30-none justify-content-center">
                                        ...
                                        $sqlzy34 = "SELECT * FROM sellerpostitem where sellerid='$selleridload' and status='Accept'";
                                                    ...
                                                    <div class="auction-content">
                                                        ...
                                                        <div class="bid-area">
                                                            ...
                                                            <div class="bid-amount">
                                                                ...
                                                                <div class="amount-content">
                                                                    <div class="current">Ended IN</div>
                                                                    <div class="amount"><?php echo $value4['biddingenddate']; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>

                                                        <div class="text-center">
                                                            <button  class="custom-button" onclick="ViewSingleProductSeller(<?php echo $value4['id']; ?>)" >View Bidders</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
