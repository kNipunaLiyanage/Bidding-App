...
<html lang="en">
    ...
    <head>
        ...
        <title>Sbidu - Buyer My Orders</title>
                    ...
                    <div class="col-sm-10 col-md-7 col-lg-4">
                        <div class="dashboard-widget mb-30 mb-lg-0">
                            ...
                            <ul class="dashboard-menu">
                                ...
                                ?>
                                <li>
                                    <a href="buyerinbox.php"><i class="flaticon-alarm"></i>Message From Sellers</a>
                                </li>
                                <li>
                                    ...
                                    <div class="tab-pane show active fade" id="current">
                                        <table class="purchasing-table">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM orderdetails where buyeremail='$emaillog'";
