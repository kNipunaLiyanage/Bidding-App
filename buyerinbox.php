                ...
                <div class="container">
                    <div class="row justify-content-center">
                                    ...
                                    if ($result2->num_rows > 0) {
                                        ...
                                        if ($row2 = $result2->fetch_assoc()) {
                                            ...
                                            <li>
                                                ...
                                                <a href="buyerinbox.php" class="active"><i class="flaticon-alarm"></i>Message From Sellers(<?php echo $row2["total"]; ?>)</a>
                                            </li>
                                            <?php
                                        }
                                    }
                        ...
                        <div class="col-lg-8">
                            ...
                            $sqlzy34 = "SELECT * FROM messages_seller_to_buyer where buyeremail='$emaillog' ORDER BY id DESC";
                                    ...
                                    <div class="alert-widget tab-pane show fade active" id="alerts">
                                        <ul>
                                            <li>
                                                ...
                                                <label for="check1">
                                                    <h6 class="title"><i class="flaticon-check text-warning"></i>&nbsp;&nbsp;You got new Message from <?php echo $value4['sellername']; ?> on <?php echo $value4['datez']; ?> at <?php echo $value4['timez']; ?> </h6>
                                                    <p><?php echo $value4['messagez']; ?> </p>

                                                    <table>
                                                        <tr>
                                                            <td> <button class="btn btn-sm btn-success" onclick="MessageSeller(<?php echo $value4['id']; ?>)">Reply</button></td>
