    ...
    <body>
                ...
                <div class="account-wrapper mt--100 mt-lg--440">
                    <div class="left-side">
                        <div class="section-header">
                            ...
                            <p>We're happy you're here As Buyer!</p>
                        ...
                        <form class="login-form" action="phpfiles/create_account_Buyer.php" enctype="multipart/form-data"  id="form">
                            ...
                            <div class="dashboard-title mb-30">
                                <h5 class="title">Registration Payment Slip</h5>
                            </div>
                            <div class="form-group mb-30">
        ...
        <script>
            $("#form").on('submit', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: "phpfiles/create_account_Buyer.php",
                    type: "POST",
